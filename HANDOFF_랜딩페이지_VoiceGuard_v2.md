...
| 요소 | 상태 | 세부 |
|------|------|------|
| 메인 카피 | ✅ 완료 | "돌봄 현장의 말이 운영을 움직입니다" |
| 서브 카피 | ✅ 완료 | "요양보호사의 발화를 즉시 구조화해..." |
...
| 요소 | 상태 | 세부 |
|------|------|------|
| 메인 카피 | ✅ 완료 | "원본은 남기고, 조치는 확인 후 이어집니다" |
| 서브 카피 | ✅ 완료 | "발화 원본과 시각을 보존한 뒤..." |
...
| 핵심 문장 | ✅ 완료 | "⭐ 핵심: 현장 발화는 보존하고, 운영 조치는 사람 확인 후 실행합니다." |
